...
const sortByChildren = (charArray) => {
  ...
  return charArray.sort((a, b) => {
    ...
    const numChildrenComparision = aChildrenCount - bChildrenCount;

    if (numChildrenComparison === 0) {
      const aHouse = a.house.replace(regex, '$1');
      const bHouse = b.house.replace(regex, '$1');
      return aHouse.localCompare(bHouse);
    }
